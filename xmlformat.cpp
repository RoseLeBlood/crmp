...
bool XmlFormat::readXmlFile(QIODevice &device, QSettings::SettingsMap &map)
{
    ...
    while (!xmlReader.atEnd() && !xmlReader.hasError()) {
        ...
        if (xmlReader.isStartElement() && xmlReader.name() != "crmp") {
...
bool XmlFormat::writeXmlFile(QIODevice &device, const QSettings::SettingsMap &map) {
    QXmlStreamWriter xmlWriter(&device);

    xmlWriter.setAutoFormatting(true);
    xmlWriter.writeStartDocument();
    xmlWriter.writeStartElement("crmp");
